...
public class SocialSplitService {
  ...
  private SocialSplitOutboxEvent event(SplitSession session,String type,Map<String,Object> payload){return event(session,type,payload,Instant.now().truncatedTo(java.time.temporal.ChronoUnit.MICROS));}
