...
5. **Diagnóstico y corrección:** `16389a0` restaura la validación exacta dentro del agregado. Es la única diferencia respecto de la revisión defectuosa. La [ejecución correctiva 35158251443](https://github.com/VillaforTech/bankpulse/actions/runs/35158251443) pasó los cuatro checks con las mismas pruebas: 100/100 renders, cero pérdidas/errores, p95 415.538 ms y reacción al vencimiento de 287.211 ms. La mutación controlada volvió a producir salidas 0 → 1 → 0.
